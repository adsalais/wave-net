//! Bench-owned test harness + unit tests for the `wave_net::multilayer_dfa` engine — the trial runner,
//! readout, DFA signal, tasks, net builders, and liveness reports (shared by `multilayer_dfa_bench` and
//! `multilayer_dfa_bitnet_bench`). Test-only; the engine itself lives in `wave_net::multilayer_dfa`.
...
pub(crate) mod harness {
    use crate::wave_net::multilayer_dfa::{multilayer_dfa_step, Edge, EligParams, TrialRecords, PSI_WIDTH};
...
mod tests {
    use super::harness::*;
    use crate::wave_net::multilayer_dfa::*;
    use crate::wave_net::config::{Config, LayerConfig};
    use crate::wave_net::network::Network;
